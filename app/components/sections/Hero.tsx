...
export default function Hero() {
  return (
    <section
      className="relative overflow-hidden py-5 md:ml-15 -mb-35 bg-no-repeat bg-left"
    >
        <div
  ...
  />
      ...
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-16">
          ...
          <div>
            <h1
              className={`${poppins.className} text-4xl sm:text-5xl xl:text-6xl font-extrabold leading-normal
              -ml-5
              max-sm:ml-0 max-sm:pl-3`}
            >
              Share Rides,
              <br />
              Split Costs,
            ...
            <p
              className={`${baloo.className} mt-6 max-w-xl text-gray-600 font-semibold text-lg leading-relaxed
              -ml-5
              max-sm:ml-0 max-sm:pl-3`}
            >
            ...
            >
              ...
              <a
                ...
                className="
                  flex items-center gap-3 rounded-2xl border border-[#9EA2A5] bg-white px-4 py-3 hover:bg-gray-100 transition
          ...
          {/* RIGHT PHONES (Desktop only, unchanged) */}
            ...
            <div className="relative w-[260px] sm:w-[300px] lg:w-[360px] mb-10">
              <Image
                ...
                className="
                  ...
                  drop-shadow-[12px_18px_35px_rgba(0,0,0,0.28)]
                "
              />
              ...
              <Image
                ...
                height={720}
                className="
                  relative z-10 right-38 top-10
                  drop-shadow-[-14px_20px_45px_rgba(0,0,0,0.35)]
                "
              />
            </div>
          </div>
