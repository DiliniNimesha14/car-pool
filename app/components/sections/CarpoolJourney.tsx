  ...
  return (
    <section className="py-8 md:py-20 bg-[#1F1F1F] sm:bg-black">
      <Container>
        ...
        <div className="flex items-start justify-space-between md:justify-center">
          {steps.map((step, index) => (
            <div key={step.title} className="flex items-center">
              ...
              {index < steps.length - 1 && (
                <div className="flex items-center -mt-6 md:-mt-12 md:px-4">
                  <div className="w-[12px] md:w-[80px] h-[1px] md:h-[2px] bg-[#74797D] relative">
